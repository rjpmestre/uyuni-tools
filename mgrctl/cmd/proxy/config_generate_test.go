...
// tests a failure proxy create config generate command when no credentials are provided.
func TestFailProxyCreateConfigGenerateWhenNoCredentialsAreProvided(t *testing.T) {
	// Setup
	...
	expectedErrorMessage := "No credentials provided"
