...
func RunPgsqlVersionUpgrade(image types.ImageFlags, upgradeImage types.ImageFlags, namespace string, nodeName string, oldPgsql string, newPgsql string) error {
